...
require (
	...
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20251007081214-26e147d01f0a // @grafana/grafana-app-platform-squad
	...
	github.com/grafana/grafana/pkg/promlib v0.0.9 // @grafana/observability-metrics
